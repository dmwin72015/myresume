...
var Tween ={Linear:function(t,b,c,d){return c * t / d + b},
    ...
    Expo:{easeIn:function(t,b,c,d){return (t == 0) ? b:c * Math.pow(2,10 * (t / d - 1)) + b}
    ...
    Elastic:{easeIn:function(t,b,c,d,a,p){if (t == 0){return b}
            if ((t /= d) == 1){return b + c}
            if (!p){p = d * 0.3}
            if (!a || a < Math.abs(c)){a = c;var s = p / 4}
            else{var s = p / (2 * Math.PI) * Math.asin(c / a)}
        return -(a * Math.pow(2,10 * (t -= 1)) * Math.sin((t * d - s) * (2 * Math.PI) / p)) + b}
        ,easeOut:function(t,b,c,d,a,p){if (t == 0){return b}
            if ((t /= d) == 1){return b + c}
            if (!p){p = d * 0.3}
            if (!a || a < Math.abs(c)){a = c;var s = p / 4}
            else{var s = p / (2 * Math.PI) * Math.asin(c / a)}
        return (a * Math.pow(2,-10 * t) * Math.sin((t * d - s) * (2 * Math.PI) / p) + c + b)}
        ,easeInOut:function(t,b,c,d,a,p){if (t == 0){return b}
    ...
    ,Bounce:{easeIn:function(t,b,c,d){return c - Tween.Bounce.easeOut(d - t,0,c,d) + b}
        ...
        ,easeInOut:function(t,b,c,d){if (t < d / 2){return Tween.Bounce.easeIn(t * 2,0,c,d) * 0.5 + b}
