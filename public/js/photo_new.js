...
(function($) {
        ...
        var CHANGTYPE = {
            ...
            'center': {
                'start': {
                    ...
                    'height': '0',
                    'margin-left': '0',
                    'top': $cont.outerWidth() / 2 + 'px',
                    'left': $cont.outerHeight() / 2 + 'px'
                },
                'end': {
        ...
        $('#left-arrow,#right-arrow').click(function(ev) {
            ...
            if (ev.target.id == 'left-arrow') {
                $imgList.stop().animate({
                    'left': curLeft <= minLeft ? curLeft + 'px' : curLeft - son_w + 'px'
                }, 420)
            } else {
                $imgList.stop().animate({
                    'left': curLeft >= 0 ? 0 : curLeft + 135 + 'px'
                }, 420)
            }
        });
    ...
    (function() {
        ...
        ({
            ...
            // url:"http://tq.360.cn/api/weatherquery/querys?app=tq360",
            // url:"http://cdn.weather.hao.360.cn/sed_api_area_query.php",
            //url:"http://tq.360.cn/api/weatherquery/querys?app=tq360&code=101020100&t=1456641496506&c=1456742516606",
            //url:"http://tq.360.cn/api/weatherquery/querys?app=tq360&code=101100101&t=1456649990344&c=1456751090445",
            //url:"http://cdn.weather.hao.360.cn/sed_api_area_query.php?grade=town&_jsonp=loadTown&code=1002",
            data: {
                // grade:'city',
                // code:'101020100',
                // city:'101010200'
